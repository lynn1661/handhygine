...
class Graph():
    ...
    def get_edge(self, layout):
        if layout == 'openpose':
            ...
            self.edge = self_link + neighbor_link
            self.center = 2
        elif layout == 'hand_wash':
            self.num_node = 42
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(0, 1), (1, 2), (2, 3), (3, 4), (0, 5), (5, 6),
                              (6, 7), (7, 8), (5, 9), (9, 10), (10, 11),
                              (11, 12), (9, 13), (13, 14), (14, 15), (15, 16),
                              (13, 17), (0, 17), (17, 18), (18, 19), (19, 20), (0, 21),
                              (21, 22), (22, 23), (23, 24), (24, 25), (21, 26), (26, 27),
                              (27, 28), (28, 29), (26, 30), (30, 31), (31, 32),
                              (32, 33), (30, 34), (34, 35), (35, 36), (36, 37),
