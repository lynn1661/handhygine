...
1. Recommended Way
   ...
   2. check line 6 in src/services/socket.js and point the url to your destinated url of the handtracker, while line 4 in src/utils/axiosInstance.js to your destinated url for other features such as ranking and login, e.g. `http://localhost:8080`
   3. open the folder in terminal and type command `docker build -t handwash .`
   4. type command `docker run -p 8080:80 -d --restart always handwash` , or operate in Docker Desktop if your OS supports.
2. Traditional Way
   ...
   4. check line 6 in src/services/socket.js and point the url to your destinated url of the handtracker, while line 4 in src/utils/axiosInstance.js to your destinated url for other features such as ranking and login, e.g. `http://localhost:8080`
