  ...
  <div class="home">
    <div class="home-top">
      <div class="flex-item">
        <div class="home-title">
          <div style="margin-left: 76px">STEP 6: FINGER TIPS</div>
          <div class="back-home">
        ...
        <div class="home-flex">
          <div class="home-img">
            <img id="hands" src="../assets/6.gif" alt="" />
          </div>
          <div class="handDiv-r">
            <div v-if="leftHand" class="hand-right">Right Hand</div>
          </div>
          <div class="handDiv-l">
            <div v-if="rightHand" class="hand-left">Left Hand</div>
          </div>
    ...
    <div>
      <a
        ref="downloadLink"
        :href="videoUrl"
        :download="downloadName + '-step6' + '.mp4'"
        style="display: none"
        >下载录制的视频</a
      >
    </div>
...
const setupMedia = async () => {
  try {
    ...
    mediaRecorder.value.addEventListener("stop", () => {
      ...
      store.commit("user/addBlob", blobString);
    });
  } catch (error) {
...
async function stopCountdown() {
  try {
    ...
    await store.dispatch("user/rating", {
      ...
      rating: text.value,
      is_last: false,
      step_video_file: `${downloadName.value}-step6`,
    });
